<div class="login login--cmo">
    ...
    <h1 class="login__login-mensaje">Cuenta Creada Exitosamente</h1>
    <div class="login__mensaje">
        <p class="login__parrafo-mensaje">Es Necesario Confirmar Tu Cuenta,<br> Revisa Tu Bandeja De Entrada</p>
    </div>
